...
export default function PantryControls({
  ...
  const { handleNativeUpload } = useReceiptStore();
        ...
        <div className="animate-slideDown">
          <div className="relative">
            <input
              ...
              className="w-full bg-gray-800/50 rounded-lg px-4 py-3 text-white focus:ring-2 ring-blue-500 focus:outline-none text-sm"
              autoFocus
            />
            <button 
              onClick={() => {
